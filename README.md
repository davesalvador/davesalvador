...
<div style="display: flex; justify-content: space-evenly; align-items: center; gap: 10px; width: 100%; height: 100vh;">
  <img 
    alt="Minji image 1" 
    src="https://github.com/davesalvador/davesalvador/blob/main/minji1.webp?raw=true" 
    style="flex: 1; max-width: 25%; height: auto; object-fit: cover; border-radius: 8px;"
  >
  <img 
    alt="Minji image 2" 
