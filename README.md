...
<div style="display: flex; justify-content: space-evenly; align-items: center; gap: 20px; height: 100vh; width: 100%;">
  <img 
    alt="Minji image 1" 
    src="https://github.com/davesalvador/davesalvador/blob/main/minji1.webp?raw=true" 
    style="width: calc(25% - 20px); height: auto; object-fit: cover; border-radius: 8px;"
  >
  <img 
    alt="Minji image 2" 
